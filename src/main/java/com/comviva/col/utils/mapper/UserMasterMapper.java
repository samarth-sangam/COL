...
public class UserMasterMapper {
	...
	public UserMaster toEntity(UserMasterDto userMasterDto) {
		return modelMapper.map(userMasterDto, UserMaster.class);
		/*
		 ...
		 * userMaster.setUsername(userMasterDto.getUsername()); } if
		 * (userMasterDto.getLocation() != null) {
		 * userMaster.setLocation(userMasterDto.getLocation()); } return userMaster;
		 */
	}

	public UserMasterDto toDto(UserMaster userMaster) {
		return modelMapper.map(userMaster, UserMasterDto.class);
		/*
		 ...
		 * userMasterDto.setUsername(userMaster.getUsername()); } if
		 * (userMaster.getLocation() != null) {
		 * userMasterDto.setLocation(userMaster.getLocation()); } return userMasterDto;
		 */
	}
